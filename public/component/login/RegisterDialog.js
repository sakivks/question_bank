...
export default class RegisterDialog extends Component {
  ...
  state = { open: this.props.open, name: '', emailId: '', username: '', password: '' };
  ...
  render() {
    return (
      <Dialog
        ...
        actions={[
          <FlatButton label={this.state.errorMessage} disabled />,
          <FlatButton label="Cancel" onTouchTap={this.handleClose} />,
          <FlatButton label="Register" primary onTouchTap={this.register} />,
        ]}
        modal={false}
